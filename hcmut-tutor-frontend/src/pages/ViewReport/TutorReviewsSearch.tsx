...
export default function TutorReviewsSearch() {
          ...
          <main className="content">
            ...
            <div className="breadcrumb-row">
              <div className="breadcrumb">
                ...
                &gt; Danh sách ghi nhận từ Tutor
              </div>
            </div>

            <div className="search-page">
              <section className="search-main">
                <div className="search-sidebar__title">Xem ghi nhận từ Tutor</div>
                <div className="search-header">
                  <h2>Danh sách các ghi nhận từ Tutor</h2>
                </div>

                <div className="search-card">
                  <div className="search-card__meta">Thời gian ghi nhận gần nhất: 26/03/2025</div>
                  ...
                  <div className="search-card__outline">
                    ...
                    <div className="detail-row detail-row--large">
                      ...
                      <div className="detail-value">Học tốt</div>
                    </div>
                  </div>
                </div>
